...
Primary design and scope-control agent for Alfa credit-scoring ML work.
...
- Objective: data intake, EDA, leakage, long-to-`id` aggregation, features, CV, baseline, training, ensemble, metrics, submission, docs?
...
- A submission is generated without preserving the `sample_submission.csv` contract (`id`, `flag`).
